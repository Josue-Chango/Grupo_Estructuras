...
Coche::Coche() : placa(""), marca(""), modelo(""), color("") {}
...
void Coche::setHoraSalida(chrono::system_clock::time_point hora) { horaSalida = hora; }
void Coche::setPlaca(const string &placa) { this->placa = placa; }
void Coche::setModelo(const string &modelo) { this->modelo = modelo; }
void Coche::setMarca(const string &marca) { this->marca = marca; }
void Coche::setColor(const string &color) { this->color = color; }
chrono::system_clock::time_point Coche::getHoraSalida() const { return horaSalida; }
string Coche::getPlaca() const { return placa; }
string Coche::getMarca() const { return marca; }
string Coche::getModelo() const { return modelo; }
string Coche::getColor() const { return color; }
int Coche::getAnio() const { return anio; }
chrono::system_clock::time_point Coche::getHora() const { return horaIngreso; }
...
std::istream &operator>>(std::istream &is, Coche &coche) {
    getline(is, coche.placa, ',');
    getline(is, coche.marca, ',');
    getline(is, coche.modelo, ',');
    getline(is, coche.color, ',');
    is >> coche.anio;
    is.ignore();
    return is;
}
...
Propietario Coche::getPropietario() const { return propietario; }
