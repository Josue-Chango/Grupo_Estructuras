...
template <typename T>
void ListaDoble<T>::mostrar(Nodo<T> *primero)
{
    if (primero == NULL)
    {
...
template <typename T>
string ListaDoble<T>::cifrarTexto(const std::string &texto)
...
template <typename T>
string ListaDoble<T>::descifrarTexto(const std::string &texto)
{
