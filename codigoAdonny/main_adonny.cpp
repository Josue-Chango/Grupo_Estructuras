...
int main() {
    ...
    std::string dato_string2;
    std::string dato_string3;
   ...
   do {
    ...
    do {
        ...
        // Mover la declaración de correoGenerado fuera del switch
        string correoGenerado;

        switch (opcion) {
        case 1:
            dato_string = ingresar_string.ingresar("ingrese el Primer Nombre: ", "string");
            dato_string2 = ingresar_string.ingresar("ingrese el Segundo Nombre: ", "string");
            dato_string3 = ingresar_string.ingresar("ingrese el Apellido: ", "string");

            // Generación del correo
            correoGenerado = gestor.generarCorreo(dato_string, dato_string2, dato_string3);
            cout << "Correo generado: " << correoGenerado << endl;
            system("pause");
            break;
