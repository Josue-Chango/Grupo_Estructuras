...
template <typename T>
void Nodo_Doble<T>::setNombre1(string _nombre1)
{
    nombre1 = _nombre1;
}

template <typename T>
string Nodo_Doble<T>::getNombre1()
{
    return nombre1;
}

template <typename T>
void Nodo_Doble<T>::setNombre2(string _nombre2)
{
    nombre2 = _nombre2;
}

template <typename T>
string Nodo_Doble<T>::getNombre2()
{
    return nombre2;
}

template <typename T>
void Nodo_Doble<T>::setApellido(string _apellido)
{
    apellido = _apellido;
}

template <typename T>
string Nodo_Doble<T>::getApellido()
{
    return apellido;
}

template <typename T>
void Nodo_Doble<T>::setCorreo(string _correo)
{
    correo = _correo;
}

template <typename T>
string Nodo_Doble<T>::getCorreo()
{
    return correo;
}
